	...
	<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/js/mainSlider.js"></script>
	...
	<script src="<?php echo get_template_directory_uri();?>/js/slick/scripts.js" type="text/javascript" ></script>
